...
if(reference == "krasnowLung"){
    ...
    file_name = sub("20210831|20210908",
                    paste0(gsub("-","",Sys.Date()),"_singleR_krasnowLung"),dataset)
    saveRDS(object = pred, file = file_name)
}
...
if(reference == "Lung30"){
    ...
    # elapsed 4872.846 sec
    file_name = sub("20210831|20210908",
                    paste0(gsub("-","",Sys.Date()),"_singleR_Lung30"),dataset)
