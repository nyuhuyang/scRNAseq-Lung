...
path <- paste0("output/",gsub("-","",Sys.Date()),"/EX_30/")
...
#saveRDS(object, file = "data/Lung_time7_20220523.rds")
...
object$day %<>% factor(levels = paste0("D",c(0,7,14,21,28,56,112)))

saveRDS(object@meta.data, file = "output/Lung_time7_metadata_20220523.rds")
saveRDS(object, file = "data/Lung_time7_20220523.rds")
...
saveRDS(object, file = "data/Lung_SCT_time7_20220523.rds")
