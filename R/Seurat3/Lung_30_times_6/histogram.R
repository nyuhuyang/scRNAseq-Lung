...
colnames(object@meta.data)[c(6,19)] = c("day","cell_types")
object$cell_types %<>% gsub("S-d", "TASC",.)
object$cell_types %<>% as.factor()
...
#Plot type 1
#x-axis: d0, d3, d7, d14, d21, d28 (note – on this plot, all cells combined per time-point)

#Plot type 2 (all time points combined)
#x-axis: BC (all subtypes), IC (all subtypes), e-S, S, TASC, p-C, C (all subtypes)

#Plot type 3 (all time points combined)
#x-axis: BC-0, BC-S, BC-p, BC1, BC-m, BC-2, IC1, IC-S, IC-2, e-S, S, TASC, p-C, C1, C2

#Plot type 4 (day 28 only)
#x-axis: BC (all subtypes), IC (all subtypes), S, TASC, p-C, C (all subtypes)
