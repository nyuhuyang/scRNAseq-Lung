...
save(sweep.res_list,file = paste0("output/Lung_16_distal_20191022_sweep.res_list.Rda"))
...
for(i in 1:length(object_list)){
    ...
    homotypic.prop <- modelHomotypic(object_list[[i]]@meta.data$major_labels)
...
meta.data = meta.data[,c("orig.ident","nCount_RNA","nFeature_RNA","tests","percent.mt",
                         ...
                         "labels","labels.colors","major_labels","Doublets")]
(load(file = "data/Lung_16_distal_20191022.Rda"))
...
save(object,file=paste0("data/Lung_16_distal_20191022.Rda"))
